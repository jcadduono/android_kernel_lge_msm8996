...
extern int lg4946_sic_abt_is_set_func(void);
extern void lg4946_sic_abt_probe(void);
extern void lg4946_sic_abt_remove(void);
extern void lg4946_sic_abt_init(struct device *dev);
extern int lg4946_sic_abt_is_debug_mode(void);
extern int lg4946_sic_abt_irq_handler(struct device *dev);
extern void lg4946_sic_abt_ocd_off(struct device *dev);
extern void lg4946_sic_abt_onchip_debug(struct device *dev, u8 *all_data);
extern void lg4946_sic_abt_report_mode(struct device *dev, u8 *all_data);
extern void lg4946_sic_abt_register_sysfs(struct kobject *kobj);
#endif
