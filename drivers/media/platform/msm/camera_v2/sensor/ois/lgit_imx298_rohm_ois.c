							...
							struct msm_ois_set_info_t *set_info)
{
		...
		case OIS_IMG_SENSOR_REG_B:
			/* RES_1 16:9 Full-resolution (4656x2620), 1108.80Mbps 30fps*/
		...
		case OIS_IMG_SENSOR_REG_D:
			/* RES_3 FHD 60fps (2328X1312), 720.00Mbps 60fps REG F by rohm*/
		...
		case OIS_IMG_SENSOR_REG_F:
			/* RES_5 HD 30fps (4656x3492), HDR, 1339.20Mbps REG E by rohm */
